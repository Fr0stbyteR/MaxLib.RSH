...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 360.0, 195.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 300.0, 255.0, 225.0, 61.0 ],
					"style" : "",
					"text" : "supervp.trans~ 1 1024 0 4 @envtrans on @shapeinv off @envpres off @transients off @maxfreq 200 @mintrans -1200 @maxtrans 1200"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.5, 405.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "s #0_mlsync"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.5, 375.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "gain $1"
				}
...
,
					"patching_rect" : [ 540.0, 345.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Lato",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 540.0, 375.0, 45.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 405.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "gain -70 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 15.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "r __SVP.Trans.In"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 75.0, 405.0, 56.0, 22.0 ],
					"restore" : 					{
						"Enable" : [ 1 ],
						"Gain" : [ 0.0 ],
						"Pitch" : [ 0.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 540.0, 315.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "RSH.Line"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 615.0, 45.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "route pitch"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 15.0, 345.0, 109.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 70.0, 90.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 223.5, 25.0, 25.0 ],
					"style" : ""
				}
